...
<div id="grid">
  ...
  <div class="card"><h3>by traffic class</h3><div class="big" id="b-kind"></div>
    ...
    <div class="legend"><i style="color:#5f96be">avs</i><i style="color:#e0b93c">mvt</i>
      ...
      <i style="color:#b48fd9">pnl</i><i style="color:#8fd9c4">bag</i><i style="color:#f0a0c8">dcs</i><i style="color:#7fd0ff">acars</i><i style="color:#ffd27f">ats</i></div></div>
...
async function poll(){
  ...
  drawSeries($("c-kind"),[S.avs,S.mvt,S.res,S.asm,S.pnl,S.bag,S.dcs||[],S.acars||[],S.ats||[]],
